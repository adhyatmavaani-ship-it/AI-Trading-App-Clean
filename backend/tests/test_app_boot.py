...
class AppBootTest(unittest.TestCase):
    ...
    def test_app_boot_lifecycle_and_core_routes(self):
        ...
        self.assertEqual(main_info_log.call_count, 4)
        self.assertEqual(main_info_log.call_args_list[0].args[0], "Trading system startup - all services initialized")
        self.assertEqual(main_info_log.call_args_list[1].args[0], "Server started on port 10000")
        self.assertEqual(main_info_log.call_args_list[2].args[0], "Trading system shutdown - cleaning up resources...")
        self.assertEqual(main_info_log.call_args_list[3].args[0], "Shutdown complete")
