...
class Settings(BaseSettings):
    ...
    user_api_key_encryption_secret: str = ""
    ml_signal_pipeline_enabled: bool = False
    ml_signal_pipeline_interval_seconds: float = 5.0
    chart_execution_bridge_enabled: bool = False
    chart_execution_bridge_interval_seconds: float = 1.0
    chart_execution_bridge_mode: Literal["mock", "testnet"] = "mock"
    ...
    execution_event_dispatcher_enabled: bool = True
    execution_event_dispatcher_interval_seconds: float = 2.0
    execution_event_dispatcher_batch_size: int = 50
    execution_event_dispatcher_max_attempts: int = 5
    execution_event_dispatcher_stall_seconds: float = 120.0
    execution_event_outbox_warning_threshold: int = 100
    execution_event_outbox_critical_threshold: int = 1_000
    broker_state_sync_enabled: bool = True
    broker_state_sync_interval_seconds: float = 60.0
    broker_state_sync_batch_size: int = 25
    broker_state_sync_max_attempts: int = 3
    broker_state_sync_lease_seconds: float = 45.0
    broker_state_freshness_seconds: float = 120.0
